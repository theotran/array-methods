...
var newNameArray = nameArray.push("Theo", "Tran");

var newGenericNumberArray = genericNumberArray.push(6, 7, 8, 9, 10);

var popResult = colors.pop();

var reversed = scrambledWords.reverse();

var reversedPhoneNumber = phoneNumber.reverse();
...
var theoOrderQueue = [{ takeOut: 'Pho' }, { takeOut: 'Sandwich'}];

var updatedOrders = orderQueue.concat(theoOrderQueue);
